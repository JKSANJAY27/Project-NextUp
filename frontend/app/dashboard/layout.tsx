...
export default function DashboardLayout({
  ...
  return (
    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col md:flex-row">
      <Suspense fallback={<div className="w-64 bg-background border-r border-border hidden md:block" />}>
        <Sidebar />
      </Suspense>
      <div className="flex-1 md:pl-64 flex flex-col min-h-screen w-full">
        {/* Sticky top navigation bar */}
        <header className="flex h-16 w-full items-center justify-between border-b border-border bg-card px-4 sm:px-8 sticky top-0 z-20">
