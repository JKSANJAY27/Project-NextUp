...
export default function TrackingStats({
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 mb-8">
      <div className="border border-border bg-card p-4 flex flex-col justify-between h-24 transition-colors hover:border-foreground/60">
      ...
      <div className="border border-yellow-500/30 bg-yellow-500/5 p-4 flex flex-col justify-between h-24">
      ...
      <div className="border border-orange-500/30 bg-orange-500/5 p-4 flex flex-col justify-between h-24">
      ...
      <div className="border border-purple-500/30 bg-purple-500/5 p-4 flex flex-col justify-between h-24">
      ...
      <div className="border border-emerald-500/30 bg-emerald-500/5 p-4 flex flex-col justify-between h-24">
